...
export default class login2 extends Component<Props> {
  constructor()
    {
        super();
        this.state = {
    ...
    Login = () =>{
          this.setState({ ActivityIndicator_Loading : true }, () =>
                 {
         fetch('https://migranwidiantara.000webhostapp.com/Z1515051060/loginpeserta.php', {
           method: 'POST',
           headers: {
                ...
                if(responseJson === 'Login berhasil!')
                 {
                     ...
                     this.props.navigation.navigate('SidePeserta',

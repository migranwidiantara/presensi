...
export default class Kegiatan extends React.Component {
  constructor() {
    ...
    makeRemote = () => {
      fetch('https://migranwidiantara.000webhostapp.com/Z1515051060/getapi.php')
    ...
    HapusData = (item) => {
      ...
      fetch('https://migranwidiantara.000webhostapp.com/Z1515051060/deleteData.php',{
        method: 'POST',
        header: {
        ...
        return (
          <View style={styles.container}>
            ...
            >
                ...
                >
                  <Icon name="cycle" style={styles.actionButtonIcon} />
                </ActionButton.Item>
